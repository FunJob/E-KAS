...
<link rel="shortcut icon" href="https://smpn7tangsel.sch.id/wp-content/uploads/2021/03/cropped-LOGO-SMPN7.png" type="image/x-icon">
...
<article class="leaderboard">
  ...
  <main class="leaderboard__profiles">
    <article class="leaderboard__profile">
      <img src="https://i.ibb.co/NSwhqHr/1.jpg" alt="Muhammad Naufal" class="leaderboard__picture">
      <span class="leaderboard__name">Muhammad Naufal</span>
      <span class="leaderboard__value">IX.1</span>
    </article>
    
    <article class="leaderboard__profile">
      <img src="https://i.ibb.co/VgfgJmY/logo-IF.png" alt="Ibnu Farel Arianto" class="leaderboard__picture">
      <span class="leaderboard__name">Ibnu Farel Arianto</span>
      <span class="leaderboard__value">IX.7</span>
    </article>
    
    <article class="leaderboard__profile">
      <img src="https://smpn7tangsel.sch.id/wp-content/uploads/2021/03/cropped-LOGO-SMPN7.png" alt="SMP NEGERI 7 TANGSEL" class="leaderboard__picture">
      <span class="leaderboard__name">SMP NEGERI 7 TANGSEL</span>
      <span class="leaderboard__value"><i class="fas fa-school"></i></span>
    </article>
